...
public class SocketClient {
    ...
    private static String message_7(){
        JSONObject obj=new JSONObject();
        obj.put("id",7);
        obj.put("IDv","V1");
        obj.put("Ticket_TGS","6oQ9MfyBLHuyyb/+2NfYPcrPfK2Ja5P8EKGWilR4njrEuvM8/LrBpjdRkja51TZhkFPKj99KD1ahLVUM3FPclwPgHiMDoW3/MdQYB544/VLblr3FdHh0n/P35KcM42TzWNr6kM3pUQGOEQFVy/n7qvmjpWJ5lMsy");
        return obj.toJSONString();
    }
